...
public class StockSender implements Runnable {
	...
	StockSender(final String topic, final StockPrice stockPriceHigh, final StockPrice stockPriceLow,
	...
	private int randomIntBetween(final Random random, final int max, final int min) {
